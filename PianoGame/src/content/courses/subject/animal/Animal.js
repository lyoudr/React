...
import { Cats, List, GrowthList, FoodList, DishesList } from '../Subjectlist';
                ...
                <div className = "row justify-content-center">
                    <div className="col-12">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                {this.state.growthlists.map((eachitem, index) => (
                                    <tr key={`age${index}`}>
...
class Food extends React.Component {
    ...
    drag(event){
        console.log('drag id is =>', event.target.id)
                            ...
                            {this.state.dishes ? 
                                <React.Fragment>
                                    {this.state.dishes.map((eachitem, index) => {
                                        ...
                                        console.log('disheslists[`${eachitem.match(/\d+/)[0]}`].name is =>',disheslists[`${eachitem.match(/\d+/)[0]}`].name);
                                        return(
...
class DropArea extends React.Component {
    ...
    submit(){
        ...
        HttpRequest.requesDishes(`${process.env.REACT_APP_HOSTURL}:8085/food`, this.state.foodspecies)
            .then(data => { 
                            ...
                            <div className = "col-12">
                                <div className="d-flex flex-wrap">
                                    {this.state.cats.map((eachitem, index) => {
                                        return(
                                            <div key={eachitem.name + eachitem.index} className="patscard show-on-scroll">
